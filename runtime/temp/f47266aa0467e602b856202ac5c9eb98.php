<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"../application/index/view/wap/wap/wap/hospital_add.html";i:1558343622;s:53:"../application/index/view/wap/wap/include/header.html";i:1558320232;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="bannertop relative" id="bannertop">
    <div class="tempWrap" style="overflow:hidden; position:relative;">
        <ul class="bannertop_container" style="width: 1920px; position: relative; overflow: hidden; padding: 0px; margin: 0px; transition-duration: 0ms; transform: translate(-384px, 0px) translateZ(0px);">
            <?php if(!empty($activity_n)): if(is_array($activity_n) || $activity_n instanceof \think\Collection || $activity_n instanceof \think\Paginator): $k = 0; $__LIST__ = $activity_n;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
            <li style="display: table-cell; vertical-align: top; width: 384px;"><img src="<?php echo $vo['img']; ?>" width="100%" onclick="openZoosUrl();return false;"></li>
...
<div class="categoryMenu main">
    <ul class="Menu">
        ...
        <li class="Menu6"><a href="<?php echo url('wap/hospital_add'); ?>">来院路线</a></li>
    </ul>
</div>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<div class="vew">
    <ul>
        <li><span class="titles">医院地址：</span><span>嘻嘻嘻嘻嘻嘻嘻嘻寻寻寻寻寻寻寻寻寻寻</span></li>
        <li><span class="titles">公交路线：</span><span>ss/手术、 手术、撒飒飒、</span></li>
        <li><span class="titles">24小时在线客服：</span><span>112552255|56323151|1245451|1545458454</span></li>
        <li><span class="titles">官方座机：</span><span>15222-55652656</span></li>
        <li><span class="titles">医院官网地址：</span><span>15222-55652656</span></li>
        <li><span class="titles">在线商城：</span><span>15222-55652656</span></li>
        <li><span class="titles">邮箱：</span><span>15222-55652656</span></li>
    </ul>
