<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/addactivity_cate.html";i:1557126475;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1560568599;}*/ ?>
<!-- 模板 -->
    ...
    <div class="layui-row">
        <div class="layui-card">
            ...
            <span class="layui-breadcrumb">
              <i>当前位置：</i>
            <a href="/">首页</a>
            <a href="#/website/activity_cate">列表</a>
            <a><cite>添加分类</cite></a>
          </span>
                ...
                <form class="layui-form" action="##" onsubmit="return false">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" lay-verify="required" value="<?php if(!empty($row['name'])): ?><?php echo $row['name']; endif; ?>" placeholder="分类名称" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="boll">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox"  <?php if((!empty($row['is_tj'])) &&   $row['is_new'] == 1): ?> checked <?php endif; ?>  name="	is_new" title="设置最新分类">
                            </div>
                            <p class="layui-word-aux">注意：如未设置， 默认为（否）。</p>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <input type="hidden" name="requestUrl" value="<?php echo url('addactivity_cate'); ?>">
                            <input type="hidden" name="id" value="<?php if(!empty($row['id'])): ?><?php echo $row['id']; endif; ?>">
                            <button class="layui-btn xxx" lay-submit lay-filter="formActivity_cate">立即提交</button>
                            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                            <a href="#/website/activity_cate" class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                    </div>
                </form>
            </div>
