<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/addreal_show_cate.html";i:1557655978;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1557829390;}*/ ?>
<!-- 模板 -->
    ...
    <div class="layui-row">
        <div class="layui-card">
            ...
            <span class="layui-breadcrumb">
              <i>当前位置：</i>
            <a href="/">首页</a>
            <a href="#/website/real_show_cate">列表</a>
            <a><cite>添加分类</cite></a>
          </span>
            ...
            <div class="layui-card-body">
                <form class="layui-form" action="##" onsubmit="return false">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <input type="hidden" name="requestUrl" value="<?php echo url('addreal_show_cate'); ?>">
                            <input type="hidden" name="id" value="<?php if(!empty($row['id'])): ?><?php echo $row['id']; endif; ?>">
                            <button class="layui-btn xxx" lay-submit lay-filter="formRealShowCate">立即提交</button>
                            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                            <a href="#/website/real_show_cate" class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                    </div>
                </form>
            </div>
