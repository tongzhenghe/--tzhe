<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/project.html";i:1558857849;s:80:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/laytablejs.html";i:1557130084;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1563155974;}*/ ?>
<style>
  .layui-table-view{
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                ...
                <div class="layui-card-body">
                  <div class="layui-card-header">
                    <a href="#/website/addproject" class="layui-btn layui-btn-xs">
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tr>
                        ...
                        <th lay-data="{field:'name', width:150}">项目名称</th>
                        <th lay-data="{field:'sort', width:200}">顺序</th>
                        <th lay-data="{field:'cate_name', width:100}">所属类别</th>
                        <th lay-data="{field:'out_url', width:100}">跳转链接</th>
                        <th lay-data="{field:'intro', width:100}">项目简介</th>
                        <th lay-data="{field:'img', width:100}">大图</th>
                        <th lay-data="{field:'state', width:100}">推荐</th>
                        <th lay-data="{field:'is_new', width:100}">最新发布</th>
                        <th lay-data="{field:'is_hot', width:100}">热门</th>
                        <th lay-data="{field:'is_tj', width:100}">状态</th>
                        <th lay-data="{field:'time', width:100}">创建时间</th>
                        <th lay-data="{field:'操作', width:120}">操作</th>
                      </tr>
                      </thead>
                      <tbody>
                      <?php if(!empty($project)): if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $k = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 2): ?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                        <td><span><a href="javascript:;"><img src="<?php echo $v['icon']; ?>" width="30px"  onclick="$.fn.preview(this)"/></a></span><span><?php echo $v['name']; ?></span></td>
                        <td><?php echo $v['sort']; ?></td>
                        <td><?php echo $v['cate_name']; ?></td>
                        <td><?php echo $v['out_url']; ?></td>
                        <td><?php echo $v['intro']; ?></td>
                        <td><img src="<?php echo $v['img']; ?>" onclick="$.fn.preview(this)" width="30"></td>

                        <td>
                          <?php if($v['is_tj'] == 1): ?>
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"   name="open" lay-skin="switch" data-field="is_tj" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  lay-text="推荐|不推荐">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="is_tj" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="推荐|不推荐">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        ...
                        <td>
                          ...
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"  name="open" lay-skin="switch" data-field="is_new" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  lay-text="是|否">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="is_new" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="是|否">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        <td>
                          ...
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"  name="open" lay-skin="switch" data-field="is_hot" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  lay-text="是|否">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="is_hot" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="是|否">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        ...
                        <td>
                          ...
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"   name="open" lay-skin="switch" data-field="state" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="state" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/project'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        ...
                        <td>
                          <a href="#/website/addproject?id=<?php echo $v['id']; ?>" ><i class="layui-icon" title="编辑数据">&#xe642;</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>" id="delPro"><i  class="layui-icon" title="删除数据">&#xe640;</i></a>
                          <a href="javascript:;" data-data="project" data-ids="<?php echo $v['id']; ?>" class="clone"><i>克隆</i></a>
                        </td>
                      </tr>
                ...
                <div class="layui-card-body">
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tr>
                        <th lay-data="{field:'id', width:100, sort:true}">(编号id)</th>
                        <th lay-data="{field:'name',sort:true, width:200}">项目名称</th>
                        <th lay-data="{field:'sort', width:200}">顺序</th>
                        <th lay-data="{field:'cate_name', width:100}">所属类别</th>
                        <th lay-data="{field:'out_url', width:100}">跳转链接</th>
                        <th lay-data="{field:'intro', width:100}">项目简介</th>
                      ...
                      <tbody>
                      <?php if(!empty($project)): if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $k = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 1): ?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                        <td><span><a href="javascript:;"><img src="<?php echo $v['icon']; ?>" width="30px"  onclick="$.fn.preview(this)"/></a></span><span><?php echo $v['name']; ?></span></td>
                        <td><?php echo $v['sort']; ?></td>
                        ...
                        <td><?php echo $v['out_url']; ?></td>
                        <td><?php echo $v['intro']; ?></td>
                        <td><img src="<?php echo $v['img']; ?>" width="20px"></td>
                        <td>
                          <?php if($v['is_tj'] == 1): ?>
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                        ...
                        <td>
                          <a href="javascript:;" data-data="project" data-ids="<?php echo $v['id']; ?>" class="clone"><i>克隆</i></a>
                          <a href="#/website/addproject?id=<?php echo $v['id']; ?>" class="point"><i class="layui-icon" title="编辑数据">&#xe642;</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/project'); ?>" id="delPro"><i  class="layui-icon" title="删除数据">&#xe640;</i></a>
                        </td>
                      </tr>
                      <?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>
