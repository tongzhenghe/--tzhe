<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/machine.html";i:1559620091;s:80:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/laytablejs.html";i:1557130084;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1563155974;}*/ ?>
<style>
  .layui-table-view{
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                ...
                <div class="layui-card-body">
                  <div class="layui-card-header">
                    <a href="#/website/addmachine" class="layui-btn layui-btn-xs">
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tbody>
                      <?php if(!empty($machine)): if(is_array($machine) || $machine instanceof \think\Collection || $machine instanceof \think\Paginator): $k = 0; $__LIST__ = $machine;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 2): ?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                        <td><?php echo $v['sort']; ?></td>
                        <td><?php echo $v['name']; ?><img src="<?php echo $v['icon']; ?>" onclick="$.fn.preview(this)" width="30"></td>
                         ...
                         <td>
                          ...
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"   name="open" lay-skin="switch" data-field="state" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/machine'); ?>"  lay-filter="switchTest_hash"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="state" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/machine'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        ...
                        <td>
                          <a href="#/website/addmachine?id=<?php echo $v['id']; ?>" ><i class="layui-icon" title="编辑数据">&#xe642;</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/machine'); ?>"   id="delMachine"><i  class="layui-icon" title="删除数据">&#xe640;</i></a>
                          <a href="#/website/machine?id=<?php echo $v['id']; ?>" class="clone"><i>克隆</i></a>
                        </td>
                      </tr>
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tr>
                        ...
                        <th lay-data="{field:'state', width:100}">状态</th>
                        <th lay-data="{field:'time', width:100}">创建时间</th>
                        <th lay-data="{field:'操作', width:150}">操作</th>
                      </tr>
                      </thead>
                      <tbody>
                      <?php if(!empty($machine)): if(is_array($machine) || $machine instanceof \think\Collection || $machine instanceof \think\Paginator): $k = 0; $__LIST__ = $machine;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 1): ?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                        <td><?php echo $v['sort']; ?></td>
                        <td><?php echo $v['name']; ?><img src="<?php echo $v['icon']; ?>" onclick="$.fn.preview(this)" width="30"></td>
                ...
                <div class="layui-card-body">
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tbody>
                      <?php if(!empty($delData)): if(is_array($delData) || $delData instanceof \think\Collection || $delData instanceof \think\Paginator): $k = 0; $__LIST__ = $delData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                        <td><?php echo $v['sort']; ?></td>
                        <td><?php echo $v['name']; ?><img src="<?php echo $v['icon']; ?>" onclick="$.fn.preview(this)" width="30"></td>
                        ...
                        <td><?php echo $v['time']; ?></td>
                        <td>
                          <a href="javascript:;"   data-table="machine" id="restore-data" data-ids="<?php echo $v['id']; ?>"><i>还原数据</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>"  dTel" data-table="machine"  id="for-del">彻底删除</a>
                        </td>
                      </tr>
