<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"../application/index/view/wap/wap/wap/newl.html";i:1558004398;s:53:"../application/index/view/wap/wap/include/header.html";i:1558423634;}*/ ?>
<!doctype html>
<html>
<head>
...
<section id="sections">
    <section class="sec01">
        ...
        <div class="jqhd_list">
            <?php if(!empty($list)): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
            <a class="zx" id="<?php echo $k; ?>" href="/zt/pzx/">
                <ul class=" clearfix">
                    ...
                    <li class="clearfix">
                        <a href="<?php echo url('wap/newl', ['id' => $vc['id']]); ?>">
                            <h4><?php if(!empty($vc['intro'])):;?><?= utf8_sub_str(unserialize($vc['intro']), 0, 50);?>...<?php Endif;?></h4>
