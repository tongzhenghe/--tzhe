<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"../application/index/view/wap/wap/wap/about_us.html";i:1558924596;s:53:"../application/index/view/wap/wap/include/header.html";i:1558423634;}*/ ?>
<!doctype html>
<html>
<head>
...
<div id="index_hm_text">
    <label class="con1_bt">酒泉华美医疗美容医院</label>
    <label class="con1_nr kj" id="intro">
        <span><a href="/wap/index">酒泉华美 @ </a></span><span ><a href="<?php if(!empty($web_setting['bscnym_path'])): ?><?php echo $web_setting['bscnym_path']; endif; ?>">客服在线 @ </a></span><span><a href="tel:0937-2620655">一键咨询</a></span>
    </label>
