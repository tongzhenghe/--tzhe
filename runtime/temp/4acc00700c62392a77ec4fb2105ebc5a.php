<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/real_show.html";i:1559350025;s:80:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/laytablejs.html";i:1557130084;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1563155974;}*/ ?>
<style>
  .layui-table-view{
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                ...
                <div class="layui-card-body">
                  <div class="layui-card-header">
                    <a href="#/website/addreal_show" class="layui-btn layui-btn-xs">
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tr>
                        ...
                        <th lay-data="{field:'img', width:100}">案例图</th>
                      ...
                      <tbody>
                      <?php if(!empty($real_show)): if(is_array($real_show) || $real_show instanceof \think\Collection || $real_show instanceof \think\Paginator): $k = 0; $__LIST__ = $real_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 2): ?>
                      <tr>
                        <td><?php echo $v['id']; ?></td>
                         ...
                         <td>
                          ...
                          <a href="javascript:;">
                            <div class="layui-input-block" style="margin-left:unset;">
                              <input type="checkbox" checked="" data-do="_state"   name="open" lay-skin="switch" data-field="state" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/real_show'); ?>"  lay-filter="switchTest_hash"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php else: ?>
                          <a href="javascript:;">
                            <div class="layui-input-block"  style="margin-left:unset;">
                              <input type="checkbox"  data-do="_state" data-field="state" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/real_show'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="正常|禁用">
                            </div>
                          </a>
                          <?php endif; ?>
                        </td>
                        ...
                        <td>
                          <a href="#/website/addreal_show?id=<?php echo $v['id']; ?>" ><i class="layui-icon" title="编辑数据">&#xe642;</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/real_show'); ?>"   id="delReal_show"><i  class="layui-icon" title="删除数据">&#xe640;</i></a>
                          <a href="#/website/real_show?id=<?php echo $v['id']; ?>" class="clone"><i>克隆</i></a>
                        </td>
                      </tr>
                ...
                <div class="layui-card-body">
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tbody>
                      <?php if(!empty($real_show)): if(is_array($real_show) || $real_show instanceof \think\Collection || $real_show instanceof \think\Paginator): $k = 0; $__LIST__ = $real_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;if($v['is_mobile'] == 1): ?>
                  ...
                  <div class="layui-card-body" style="top: 10px;">
                    <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                      ...
                      <tr>
                        ...
                        <td><?php echo $v['time']; ?></td>
                        <td>
                          <a href="javascript:;"  data-table="real_show" id="restore" data-ids="<?php echo $v['id']; ?>"><i>还原数据</i></a>
                          <a href="javascript:;" data-ids="<?php echo $v['id']; ?>" class="clone dTel" data-table="real_show"  id="for-del">彻底删除</a>
                        </td>
                      </tr>
