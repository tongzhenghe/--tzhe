<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/keywords_link.html";i:1560586963;s:80:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/laytablejs.html";i:1557130084;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1563155974;}*/ ?>
<style>
    .layui-table-view{
            ...
            <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">
                  ...
                  <div class="layui-card-body">
                      <div class="layui-card-header">
                      <a href="#/website/addkeywords_link" class="layui-btn layui-btn-xs">
                      ...
                      <div class="layui-card-body" style="top: 10px;">
                          <table lay-filter="demo"  lay-data="{height:315, page:true, id:'test'}" >
                              ...
                              <tr>
                                  ...
                                  <th lay-data="{field:'re_keywords', width:100}">关联词</th>
                                  <th lay-data="{field:'link', width:100}">关联链接</th>
                              ...
                              <tbody>
                              <?php if(!empty($keywords_link)): if(is_array($keywords_link) || $keywords_link instanceof \think\Collection || $keywords_link instanceof \think\Paginator): $k = 0; $__LIST__ = $keywords_link;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
                              <tr>
                                  <td><?php echo $v['id']; ?></td>
                                  <td><span><?php echo $v['re_keywords']; ?></span></td>
                                  <td><span><a href="<?php echo $v['link']; ?>" target="_blank" style="color: #398fff"><?php echo $v['link']; ?></span></td>
                                  <td><?php echo $v['time']; ?></td>
                                  <td>
                                      <?php if($v['state'] == 1): ?>
                                      <a href="javascript:;">
                                          <div class="layui-input-block" style="margin-left:unset;">
                                              <input type="checkbox" checked="" data-do="_state"   name="open" lay-skin="switch" data-field="state" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/keywords_link'); ?>"  lay-filter="switchTest_hash"  lay-text="正常|禁用">
                                          </div>
                                      </a>
                                      <?php else: ?>
                                      <a href="javascript:;">
                                          <div class="layui-input-block"  style="margin-left:unset;">
                                              <input type="checkbox"  data-do="_state" data-field="state" data-ids="<?php echo $v['id']; ?>"  data-url="<?php echo url('index/keywords_link'); ?>"  lay-filter="switchTest_hash"  name="close" lay-skin="switch"  lay-text="正常|禁用">
                                          </div>
                                      </a>
                                      <?php endif; ?>
                                  </td>
                                  ...
                                  <td>
                                      <a href="#/website/addkeywords_link?id=<?php echo $v['id']; ?>" ><i class="layui-icon" title="编辑数据">&#xe642;</i></a>
                                      <a href="javascript:;" data-ids="<?php echo $v['id']; ?>" data-url="<?php echo url('index/keywords_link'); ?>" id="delKeywords_link"><i  class="layui-icon" title="删除数据">&#xe640;</i></a>
                                  </td>
                              </tr>
