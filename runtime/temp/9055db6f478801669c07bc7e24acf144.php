<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/addsubject_cate.html";i:1560583944;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1562054213;}*/ ?>
<!-- 模板 -->
<div class="layui-fluid">
    <div class="layui-row">
        <div class="layui-card">
            ...
            <a href="#/website/subject_cate">列表</a>
            <a><cite>添加分类</cite></a>
          </span>
            ...
            <div class="layui-card-body">
                <form class="layui-form" action="##" onsubmit="return false">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <input type="hidden" name="requestUrl" value="<?php echo url('addsubject_cate'); ?>">
                            <input type="hidden" name="id" value="<?php if(!empty($row['id'])): ?><?php echo $row['id']; endif; ?>">
                            <button class="layui-btn xxx" lay-submit lay-filter="formSubject_cate">立即提交</button>
                            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                            <a href="#/website/subject_cate" class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                    </div>
                </form>
            </div>
