<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/addnews_cate.html";i:1557132016;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1558233882;}*/ ?>
<!-- 模板 -->
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                <form class="layui-form" action="##" onsubmit="return false">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <input type="hidden" name="requestUrl" value="<?php echo url('addnews_cate'); ?>">
                            <input type="hidden" name="id" value="<?php if(!empty($row['id'])): ?><?php echo $row['id']; endif; ?>">
                            <button class="layui-btn xxx" lay-submit lay-filter="formNews_cate">立即提交</button>
                            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                            <a href="#/website/news_cate" class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                    </div>
                </form>
            </div>
