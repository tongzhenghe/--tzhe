<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/huamei.jqzxyy.com/public/../application/webadmin/view/index/adduser.html";i:1560327747;s:76:"/www/wwwroot/huamei.jqzxyy.com/application/webadmin/view/include/submit.html";i:1562921599;}*/ ?>
<!-- 模板 -->
          ...
          <form class="layui-form" action="##" onsubmit="return false" >
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" name="pername"  value="<?php if(!empty($row['pername'])): ?><?php echo $row['pername']; endif; ?>" placeholder="管理员姓名" autocomplete="off" class="layui-input">
              </div>
            </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="text" name="username"  value="<?php if(!empty($row['username'])): ?><?php echo $row['username']; endif; ?>" placeholder="登陆用户名" autocomplete="off" class="layui-input">
              </div>
            </div>
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="password" name="password"  placeholder="管理员链接" autocomplete="off" class="layui-input">
              ...
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <ul id="demo2" class="layui-box layui-tree layui-show">
                          ...
                          <li>
                              ...
                              <a href="javascript:;"><cite class="top"><?php echo $v['name']; ?></cite></a>
                              <ul class="layui-show">
                                  <?php if(!empty($v['children'])): if(is_array($v['children']) || $v['children'] instanceof \think\Collection || $v['children'] instanceof \think\Paginator): $kc = 0; $__LIST__ = $v['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vc): $mod = ($kc % 2 );++$kc;?>
                                  <li>
                                      <input type="checkbox" name="like1[game]" lay-skin="primary">
                                      <a href="javascript:;">
                                          <cite><?php echo $vc['name']; ?></cite></a>
                                      <ul class="layui-show">
                                          <?php if(!empty($vc['children'])): if(is_array($vc['children']) || $vc['children'] instanceof \think\Collection || $vc['children'] instanceof \think\Paginator): $ks = 0; $__LIST__ = $vc['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($ks % 2 );++$ks;?>
                                          <li>
                                              <input type="checkbox" name="like1[game]" lay-skin="primary">
                                              <a href="javascript:;">
                                                  <cite><?php echo $vs['name']; ?></cite>
                                              </a>
                                          </li>
            ...
            <div class="layui-form-item">
              <div class="layui-input-block">
                  <input type="hidden" name="requestUrl"  value="<?php echo url('adduser'); ?>">
                  <input type="hidden" name="id"  value="<?php if(!empty($row['id'])): ?><?php echo $row['id']; endif; ?>">
                <button class="layui-btn xxx" lay-submit lay-filter="formUser">立即提交</button>
                <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                <a href="#/website/user" class="layui-btn layui-btn-primary">返回列表</a>
              </div>
            </div>
          </form>
        </div>
