...
return [
    ...
    // 视图输出字符串内容替换
    'view_replace_str'       => [
        '{__CSS_PATH}' => DS.'static'.DS.'index'.DS.'pc'.DS.'css'.DS,                 //public 目录
        '{__JS_PATH}' =>  DS.'static'.DS.'index'.DS.'pc'.DS.'js'.DS,                //public 目录
        '{__IMG_PATH}' =>DS.'static'.DS.'index'.DS.'pc'.DS.'pctestImg'.DS,
        '{__ICON_PATH}' =>DS.'static'.DS.'index'.DS.'pc'.DS.'icon'.DS,
    ],
